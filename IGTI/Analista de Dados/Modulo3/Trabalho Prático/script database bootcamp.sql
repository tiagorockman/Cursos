...
CREATE TABLE IF NOT EXISTS `bootcamp`.`caracteristicasgerais` (
  ...
  `dsccaracteristicasGerais` VARCHAR(150) NULL,
...
CREATE TABLE IF NOT EXISTS `bootcamp`.`caracteristicageralimovel` (
  `idcaracteristicasImovel` INT NULL,
  `idcaracteristicasGerais` INT NULL,
  `idImovel` INT NULL,
  `temCaracteristica` TINYINT NULL,
  `caracteristicageralimovelcol` VARCHAR(45) NULL,
  `caracteristicasgerais_idcaracteristicasGerais` INT NOT NULL,
  INDEX `fk_idImovel_idx` (`idImovel` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Data for table `bootcamp`.`caracteristicasgerais`
-- -----------------------------------------------------
START TRANSACTION;
USE `bootcamp`;
INSERT INTO `bootcamp`.`caracteristicasgerais` (`idcaracteristicasGerais`, `dsccaracteristicasGerais`) VALUES (1, 'Portaria 24 horas');
INSERT INTO `bootcamp`.`caracteristicasgerais` (`idcaracteristicasGerais`, `dsccaracteristicasGerais`) VALUES (2, 'Elevador');
INSERT INTO `bootcamp`.`caracteristicasgerais` (`idcaracteristicasGerais`, `dsccaracteristicasGerais`) VALUES (3, 'Piscina');
